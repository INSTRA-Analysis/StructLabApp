...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("StructLab V1.0 — 2D Structural Analysis")
    ...
    def _build_menu(self) -> None:
        ...
        _add("Gerber Beam — IPE 360, internal hinge", P.demo_gerber)
    ...
    def _build_overlay_toolbar(self) -> None:
        ...
        self._def_scale_spin.setValue(1.0)
    ...
    def _update_title(self) -> None:
        ...
        self.setWindowTitle(f"{prefix}{fname} — StructLab V1.0")
    ...
    def _on_export_svg(self) -> None:
        ...
        gen.setDescription("Generated by StructLab V1.0")
