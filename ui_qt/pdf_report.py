...
def generate_report(
    ...
    with PdfPages(filepath) as pdf:
        ...
        info["Creator"]      = "StructLab V1.0 — Direct Stiffness Method"
...
def _footer(fig: plt.Figure, date_str: str, page_note: str = "") -> None:
    ...
    fig.text(_L, 0.022, f"Generated: {date_str}  |  StructLab V1.0",
...
def _page_signoff(pdf: PdfPages, meta: Any, date_str: str,
    ...
    _footer(fig, date_str,
            page_note="This report is generated by StructLab V1.0")
    ...
    disc.text(0.03, 0.06, "© StructLab V1.0 — Direct Stiffness Method Engine",
